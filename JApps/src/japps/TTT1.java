...
ic1=new ImageIcon(ClassLoader.getSystemResource("icon/ic1.jpg"));
ic2=new ImageIcon(ClassLoader.getSystemResource("icon/ic2.jpg"));
ic11=new ImageIcon(ClassLoader.getSystemResource("icon/ic11.JPG"));
ic22=new ImageIcon(ClassLoader.getSystemResource("icon/ic22.JPG"));
